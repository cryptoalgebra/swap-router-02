...
import { IBaseV1Pair, IWETH9, MockTimeSwapRouter02, MixedRouteQuoterV1, TestERC20 } from '../typechain'
...
describe('SwapRouter', function () {
  ...
  async function createV2Pool(tokenA: TestERC20, tokenB: TestERC20): Promise<IBaseV1Pair> {
    await factoryV2.createPair(tokenA.address, tokenB.address)

    const pairAddress = await factoryV2.getPair(tokenA.address, tokenB.address)
    const pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IBaseV1Pair
  ...
  describe('swaps - v2', () => {
    let pairs: IBaseV1Pair[]
    let wethPairs: IBaseV1Pair[]
